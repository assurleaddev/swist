...
from payments import stripe_handler, paypal_handler # Import the new PayPal handler
...
app.include_router(paypal_handler.router, prefix="/api/payments", tags=["Payments"]) # Include the PayPal router
